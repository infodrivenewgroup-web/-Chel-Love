...
export function PaymentFlow({ price, onComplete, onCancel }: PaymentFlowProps) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-md mx-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6 space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-gray-800 font-medium">Банк Уралсиб</span>
            </div>
          </div>
          ...
          {showInstructions && (
            <div className="bg-gray-50 rounded-xl p-4 mb-4 text-sm text-gray-600 space-y-2">
              ...
              <p>4. Выберите банк получателя: Банк Уралсиб</p>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
        {verifyProgress < 100 ? (
          ...
          <>
            ...
            <button
              onClick={onComplete}
              className="w-full py-4 px-6 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-bold transition-all"
            >
              ПЕРЕЙТИ К ОТЧЕТУ
            </button>
          </>
